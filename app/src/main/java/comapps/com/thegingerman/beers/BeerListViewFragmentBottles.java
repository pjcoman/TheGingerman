 ...
 */
public class BeerListViewFragmentBottles extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            ...
            query.orderByAscending("name").whereEqualTo("group", "BOTTLES");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Bundle bundle = this.getArguments();
        String setLocation = bundle.getString("location", "");
        ...
        try {
            // Locate the class table named "stansbeers" in Parse.com
            ParseQuery<ParseObject> query = new ParseQuery<>(setLocation + "drinks").fromLocalDatastore();
            // Locate the column named "name" in Parse.com and order list
            // by ascending

            query.whereEqualTo("group", "BOTTLES");
